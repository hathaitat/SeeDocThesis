    ...
    @objc func checkText (textfield: UITextField){
        ...
        @objc func checkText2 (textfield: UITextField){
            if (idCardField.text?.count ?? 0 < 14){
                checkText2.text = "เลขบัตรประชาชน 13 หลัก"
...
//        let idPatient = idPatientField.text
        ...
        let formFilled = username != nil && username != "" && email != nil && email != "" && password != nil && password != "" && idCard != nil && idCard != "" && birthday != nil && birthday != ""
...
//
                                ...
                                ref2 = db.collection("newuser").addDocument(data: [
                                "uid": uid
                                ])
