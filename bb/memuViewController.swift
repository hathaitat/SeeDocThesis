...
class memuViewController: UIViewController {
    ...
    func gg() {
        ...
        let data = [
            ...
            "Tue":["08.30 - 09.30","09.31 - 10.30","10.31 - 11.30"],
            
        ]
        ref = db.collection("doctor").addDocument(data: [
            "deptDoc": "แผนกอายุรกรรม",
            "imageDoc": "",
            "nameDoc": "รศ.พญ.สิริภา ช้างศิริกุลชัย",
            "scheduleDoc": data
        ]) { err in
            if let err = err {
...
//                                    self.showDayDoc.text = dayAppoint
                ...
                print(self.dayAppoint2)
                    ...
                    /////////////////////////////////////////////////////////////////////////////////////////////////////
//                let aaaa : String = aaa[1] //แปลงส่วนของเดือน
//                    if aaaa == "Apr" {
//                        self.appendMount = 04
//                    }else if aaaa == "May" {
//                        self.appendMount = 05
